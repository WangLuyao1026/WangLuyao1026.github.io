...
<section class="hero-container">
  ...
  <div class="hero-text-body hero-shift-right">
    ...
    <div class="identity-badges">
      <span class="badge-item">NANJING UNIVERSITY</span>
      <span class="badge-item">新闻传播学院</span>
    </div>
  </div>
</section>
  ...
  <div class="reflection-paper">
    <div class="paper-content">
      ...
      <div class="paper-body-standard">
        <p>
          当那些关于传播效能、舆论生成和社会心态“未尽的追问”，在媒体深度融合的浪潮中强烈地叩击着我。于是，在2025年9月，我选择奔赴自己的梦校——南京大学，去学习如何在新闻传播与计算思维的逻辑里，解析那些隐藏在算法背后的社会脉动。
        </p>
      </div>
      <div class="paper-action">
        <a href="/news/reflection/" class="btn-paper">阅读转型手记全文 &rarr;</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="gallery-grid">
    <div class="gallery-item">
      <div class="gallery-img">
        <img src="/assets/img/部分奖项1.png" alt="Award 1">
      </div>
      <p class="gallery-cap">全国政法系统“三微”比赛十佳作品等</p>
    </div>
    <div class="gallery-item">
      <div class="gallery-img">
        <img src="/assets/img/部分奖项2.png" alt="Award 2">
      </div>
      <p class="gallery-cap">年度优秀新闻报道 / 宣传工作先进个人</p>
    </div>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="portfolio-grid">
    <div class="pf-card">
      <a href="/projects/" class="pf-link">
        <div class="pf-visual">
          <img src="/assets/img/about展示封面-微光.jpg" alt="Micro-film">
          <div class="pf-overlay"><span>观看影片</span></div>
        </div>
        <div class="pf-meta">
          <span class="pf-cat">Micro-film</span>
    ...
    <div class="pf-card">
      <a href="/projects/" class="pf-link">
        <div class="pf-visual">
          <img src="/assets/img/about展示封面-1.png" alt="VI Design">
          <div class="pf-overlay"><span>浏览设计</span></div>
        </div>
        <div class="pf-meta">
          <span class="pf-cat">Visual Identity</span>
          <h5 class="pf-title">创意视觉识别设计</h5>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="mt-5 text-center">
    <a href="/projects/" class="btn-main">进入作品集长廊</a>
  </div>
</section>
  ...
  <div class="skills-grid">
    ...
    <div class="skill-category">
      ...
      <div class="skill-tags skill-tags-vertical">
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-film"></i><span>Premiere Pro</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-wand-magic-sparkles"></i><span>After Effects</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-headphones"></i><span>Audition</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fab fa-apple"></i><span>Final Cut Pro</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-scissors"></i><span>剪映专业版</span></div>
      </div>
    </div>

    <!-- 第 2 行 第 2 列：数据分析（每标签独占一行） -->
    <div class="skill-category">
      <div class="skill-cat-header">
        <div class="skill-cat-line"></div>
      ...
      <div class="skill-tags skill-tags-vertical">
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-file-word"></i><span>Office / WPS</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-database"></i><span>SQL</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fab fa-python"></i><span>Python</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fab fa-r-project"></i><span>R</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-chart-bar"></i><span>Stata</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-project-diagram"></i><span>Gephi</span></div>
      </div>
    </div>

    <!-- 第 2 行 第 3 列：AI 应用（每标签独占一行） -->
    <div class="skill-category">
      <div class="skill-cat-header">
        <div class="skill-cat-line"></div>
      ...
      <div class="skill-tags skill-tags-vertical">
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-code"></i><span>Vibe Coding</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-video"></i><span>即梦</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-wand-magic"></i><span>可灵</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-film"></i><span>海螺</span></div>
        <div class="skill-tag skill-tag-vertical"><i class="fas fa-music"></i><span>Max</span></div>
      </div>
    </div>
  </div>
</section>
...
<section class="content-section mb-6">
  <div class="thesis-block">
    ...
    <div class="thesis-content">
      <span class="thesis-tag">UNDERGRADUATE RESEARCH</span>
      <h4 class="thesis-title">《云录制的生产制播范式与效用研究》</h4>
      <p class="thesis-desc">
        通过个案分析探讨疫情期间“云录制”节目的生产流程重构与互动机制演变。该研究认为，云录制不仅是应急之举，更是媒体深度融合背景下的技术与文化预演。
      </p>
      <a href="/publications/" class="thesis-link">阅读研究详情 <i class="fas fa-arrow-right"></i></a>
    </div>
  </div>
</section>
...
<section class="content-section">
  <div class="wilderness-box">
    ...
    <div class="wilderness-content-serif">
      ...
      <p>
        如今，我满怀热忱，带着在新闻一线的沉淀重返校园，不仅是为了知识的更新，更是为了思维的重构。我期待以学术成果回应时代命题，在计算传播领域留下扎实的足迹。 愿在这片人文沃土中深扎根系，如南大校园里蓄势待发的海棠，在严谨求索中积蓄力量，去拥抱辽阔的春天。
      </p>
    </div>
  </div>
</section>
...
<div class="site-footer">
  ...
  <p class="footer-sub">南京大学新闻传播学院 · 中国南京</p>
</div>

<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@400;700;900&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Playfair+Display:wght@700;800&display=swap" rel="stylesheet">
...
<style>
  ...
  /* 语言切换 */
  .lang-switcher-fixed { position: absolute; top: 20px; right: 20px; font-family: sans-serif !important; font-size: 0.9rem; z-index: 99; }
  .ls-link { color: #bbb; }
  ...
  /* Hero Section */
  .hero-container {
    position: relative; padding: 80px 40px; background: linear-gradient(180deg, var(--bg-soft) 0%, #fff 100%);
    border-radius: 8px; margin-bottom: 5rem; border: 1px solid var(--border-color);
  }
  .hero-brand-mark { position: absolute; top: 30px; right: 30px; }
  .brand-logo { height: 80px; width: auto; opacity: 0.9; }

  .name-en-bar { display: block; border-top: 1px solid rgba(0,0,0,0.05); padding-top: 5px; }
  .name-en { 
    font-family: 'Playfair Display', serif !important; font-size: 0.9rem; letter-spacing: 9px; 
    color: #666; font-weight: 700; display: block; margin-left: 5px; 
  }
  ...
  .intro-sub { font-size: 1rem; color: var(--text-light); }
  ...
  .head-cn { font-family: 'Playfair Display', "Noto Serif SC", serif !important; font-size: 1.8rem; font-weight: 800; letter-spacing: 4px; color: #000; margin-bottom: 5px; }
  ...
  /* 知识旷野装饰 */
  .wilderness-box { position: relative; padding: 0 20px; max-width: 800px; margin: 0 auto; text-align: left; }
  .wilderness-deco { font-family: serif; font-size: 6rem; color: var(--bg-soft); line-height: 0; position: absolute; top: 0; left: -20px; z-index: -1; font-weight: 900; }
  .wilderness-quote { background: #faf9fd; padding: 25px 30px; border-left: 4px solid var(--primary); border-radius: 0 8px 8px 0; margin: 2rem 0; font-style: italic; color: #555; font-size: 1.1rem; line-height: 1.9; }
  .quote-author { display: block; text-align: right; font-size: 0.9rem; color: #888; margin-top: 10px; font-style: normal; }
  ...
  .tl-marker::after { content: ""; width: 11px; height: 11px; background: #fff; border: 3px solid var(--primary); border-radius: 50%; position: absolute; left: 50%; top: 5px; transform: translateX(-50%); }
  ...
  .gallery-cap { text-align: center; font-size: 0.9rem; color: #777; margin-top: 10px; }
  .portfolio-grid { display: grid; grid-template-columns: repeat(md, 1fr); gap: 40px; }
  @media (min-width: 768px) { .portfolio-grid { grid-template-columns: 1fr 1fr; } }
  .pf-visual { position: relative; border-radius: 8px; overflow: hidden; height: 260px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); }
  .pf-visual img { width: 100%; height: 100%; object-fit: cover; transition: 0.6s; }
  .pf-link:hover img { transform: scale(1.08); }
  .pf-overlay { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(77,0,153,0.7); display: flex; align-items: center; justify-content: center; opacity: 0; transition: 0.3s; }
  .pf-link:hover .pf-overlay { opacity: 1; }
  .pf-overlay span { color: #fff; border: 1px solid #fff; padding: 8px 20px; border-radius: 50px; font-size: 0.9rem; }
  .pf-meta { text-align: center; padding: 20px 0; }
  ...
  .tm-text { font-size: 0.85rem; font-weight: 700; text-align: center; line-height: 1.2; margin-top: 5px; }
  .thesis-tag { font-family: sans-serif !important; font-size: 0.7rem; color: #999; letter-spacing: 1px; }
  .thesis-title { font-size: 1.5rem; font-weight: 800; margin: 10px 0 15px 0; color: #000; }
  ...
  .footer-info { color: #666; font-size: 0.95rem; font-family: sans-serif !important; }
  .footer-info .sep { margin: 0 15px; color: #eee; }
  .footer-sub { font-size: 0.85rem; color: #aaa; margin-top: 10px; }
  ...
  @media (max-width: 768px) {
    ...
    .tl-left { text-align: left; width: auto; padding-right: 0; margin-bottom: 5px; }
    .tl-marker { border-left: 1px solid #eee; height: auto; width: 0; position: absolute; left: 0; top: 30px; bottom: 0; }
    .tl-marker::after { left: 0; top: 0; transform: translateX(-50%); }
    .tl-right { padding-left: 25px; border-left: 1px solid #eee; margin-left: 0; }
  }
</style>
