...
<section class="content-section">
  ...
  <div class="competency-grid">
    ...
    <div class="comp-item highlight">
      ...
      <div class="comp-text">
        <h5>数据能力</h5>
        <p>擅长使用 Python/R 进行社会网络分析 (SNA)、网络数据分析和高级统计等，研究兴趣目前为用户心理与行为的量化研究与思考。</p>
      </div>
    </div>
    <div class="comp-item">
      <div class="comp-icon">💡</div>
      <div class="comp-text">
        <h5>理论视野</h5>
        <p>聚焦智媒时代下数据、技术、媒体与社会结构之间的深度互动与张力，在跨学科视野中保持批判性思考与观察。</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="reflection-paper">
    <div class="paper-content">
      ...
      <div class="paper-body-standard">
        <p>
          当那些关于传播效能、舆论生成和社会心态“未竟的追问”，在媒体深度融合的浪潮中强烈地叩击着我。于是，在2025年9月，我选择奔赴自己的梦校——南京大学，去学习在新闻传播与计算思维的逻辑里，解析那些隐藏在算法背后的社会脉动。
        </p>
      </div>
  ...
  <div class="timeline-clean">
    ...
    <div class="tl-item">
      ...
      <div class="tl-right">
        ...
        <p class="tl-desc">负责齐鲁医院等山东省内三甲医院健康传播运营。独立完成策划、拍摄与后期，打造播放量 <strong>10万+</strong> 的爆款视频。</p>
      </div>
    </div>
...
<section class="content-section">
  <div class="wilderness-box">
    ...
    <div class="wilderness-content-serif">
      ...
      <p>
        如今，我满怀热忱，重返校园以期汲取更多知识养分。愿在这片学术的沃土里，继续追逐梦想，像校园里即将肆意绽放的海棠一样，希望以后都是美好的春天！
      </p>
    </div>
  </div>
</section>
